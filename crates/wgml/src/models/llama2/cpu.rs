...
impl Llama2Config {
    ...
    pub fn from_gguf_with_model_type(gguf: &Gguf, model_type: LlamaModelType) -> Self {
        ...
        Self {
            ...
            hidden_dim: gguf.metadata[&hidden_dim].unwrap_u32() as usize,
            n_layers: gguf.metadata[&n_layers].unwrap_u32() as usize,
            n_q_heads: gguf.metadata[&n_q_heads].unwrap_u32() as usize,
